...
function App() {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-800 text-orange-500">
      <div className="w-full max-w-md shadow-md rounded-lg px-4 py-6 bg-gray-700">
